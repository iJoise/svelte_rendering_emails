...
<mj-section background-color="#fafafa">
    <mj-column width="560px">
        ...
        <mj-text color="#525252" font-size="16px">
            ...
            augue semper. Aliquam erat volutpat. Cras id dui lectus. Vestibulum sed finibus lectus, sit amet suscipit
            nibh. Proin nec commodo purus. Sed eget nulla elit. Nulla aliquet mollis faucibus.
        </mj-text>
...
<mj-section background-color="white">
    ...
    <mj-column>
        ...
        <mj-text>
            ...
            quibusdam sequi similique tempora. Aperiam ea, earum eius maiores molestiae natus possimus ratione sequi vel
            veritatis.
        </mj-text>
